...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'whapi/1.8.7 (api/6.1.3)');
  }
   ...
   * Get story
   *
   * @throws FetchError<400, types.GetStoryResponse400> Wrong request parameters
   * @throws FetchError<404, types.GetStoryResponse404> Specified story not found
   * @throws FetchError<500, types.GetStoryResponse500> Internal Error
   */
  getStory(metadata: types.GetStoryMetadataParam): Promise<FetchResponse<200, types.GetStoryResponse200>> {
    return this.core.fetch('/stories/{MessageID}', 'get', metadata);
  }

  /**
   * Copy story
   *
   * @throws FetchError<400, types.CopyStoryResponse400> Wrong request parameters
   * @throws FetchError<404, types.CopyStoryResponse404> Specified story not found
   * @throws FetchError<500, types.CopyStoryResponse500> Internal Error
   */
  copyStory(body: types.CopyStoryBodyParam, metadata: types.CopyStoryMetadataParam): Promise<FetchResponse<201, types.CopyStoryResponse201>> {
    return this.core.fetch('/stories/{MessageID}', 'put', body, metadata);
  }

  /**
   * Delete story
   *
   * @throws FetchError<400, types.DeleteStoryResponse400> Wrong request parameters
   * @throws FetchError<404, types.DeleteStoryResponse404> Specified story not found
   * @throws FetchError<500, types.DeleteStoryResponse500> Internal Error
   */
  deleteStory(metadata: types.DeleteStoryMetadataParam): Promise<FetchResponse<200, types.DeleteStoryResponse200>> {
    return this.core.fetch('/stories/{MessageID}', 'delete', metadata);
  }
   ...
   *
   * @summary Reject call
   * @throws FetchError<400, types.RejectCallResponse400> Wrong request parameters
   * @throws FetchError<401, types.RejectCallResponse401> Need channel authorization for add community
   * @throws FetchError<404, types.RejectCallResponse404> Call not found
   * @throws FetchError<500, types.RejectCallResponse500> Internal Error
   */
  rejectCall(body: types.RejectCallBodyParam, metadata: types.RejectCallMetadataParam): Promise<FetchResponse<200, types.RejectCallResponse200>> {
    return this.core.fetch('/calls/{CallID}/reject', 'post', body, metadata);
  }
}
